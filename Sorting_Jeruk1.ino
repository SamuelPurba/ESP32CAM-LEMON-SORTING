const char* ssid     = "Bennedeta";   //your network SSID
const char* password = "gatahuaku";   //your network password
    ...
    <body>
            ...
            <table style="border:0px;width:350px">
              ...
              <tr>
                <td colspan="3">
                <div id="divColor1">
                  <table style="border:4px yellow solid;width:100%;">
                  <tr>
                ...
                <div id="divColor2" style="display:block">
    ...
    tracker.on('track', function(event) {
      ...
      event.data.forEach(function(rect) {
        ...
        if (rect.color=="red") {
          ...
          ledcWrite(5, LOW);// GPIO 12 
          ledcWrite(4, HIGH);// GPIO 13
          ...
          ledcWrite(5, HIGH);// GPIO 12
          ledcWrite(4, LOW);// GPIO 13
